...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'news-categories', name: 'NewsCategories', component: () => import('@/views/news/CategoryList.vue'), meta: { title: '新闻分类', breadcrumbs: [{ label: '资讯管理', to: '/news-categories' }, { label: '新闻分类', to: '/news-categories' }] } },
      { path: 'news', name: 'News', component: () => import('@/views/news/NewsList.vue'), meta: { title: '新闻管理', breadcrumbs: [{ label: '资讯管理', to: '/news' }, { label: '新闻管理', to: '/news' }] } },
      { path: 'applications', name: 'Applications', component: () => import('@/views/applications/ApplicationList.vue'), meta: { title: '应用领域' } },
